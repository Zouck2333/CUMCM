...
def verify_purchase_risk(audit, solution, inputs, daily_by_date, detail_by_date, abs_tol):
    ...
    if diag.get("parameter_mode") == "causal_monthly":
        from verify_causal_policy import verify_causal_solution
        verify_causal_solution(audit,solution,inputs,daily_by_date,detail_by_date,abs_tol)
        return
