...
|---|---:|---:|
| 滚动方案 | 14,705,987.34 | — |
| 匹配完美信息 MILP | 12,232,434.07 | Gap_info = 20.2213% |
| 完美信息 LP 下界 | 12,226,042.07 | Gap_LP = 20.2841% |
...
- 匹配 MILP：status=0，MIP gap=3.776515615920245e-08，耗时 263.968 秒。
- LP 下界：status=0，迭代次数=116645，耗时 3.844 秒。
- 匹配 MILP 物理核验：通过。
- LP 下界物理核验：通过。
