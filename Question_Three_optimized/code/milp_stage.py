    ...
    *,
    ...
    if initial_grid is not None:
        for t in range(n):
            ...
            # Both adjustment slopes are positive. For any fixed G, reducing
            # up and down by their common minimum preserves G-G0 and lowers
            # every scenario cost. Thus their convex epigraph needs no binary
            # sign variable, including under subsequent upper cost locks.
