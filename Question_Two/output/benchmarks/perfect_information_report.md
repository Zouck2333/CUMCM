...
|---|---:|---:|
| 滚动方案 | 15,696,285.05 | — |
| 匹配完美信息 MILP | 12,287,221.16 | Gap_info = 27.7448% |
| 完美信息 LP 下界 | 12,226,042.07 | Gap_LP = 28.3840% |
...
- 匹配 MILP：status=0，MIP gap=2.4727987640666046e-09，耗时 133.643 秒。
- LP 下界：status=0，迭代次数=116645，耗时 4.318 秒。
- 匹配 MILP 物理核验：通过。
- LP 下界物理核验：通过。
