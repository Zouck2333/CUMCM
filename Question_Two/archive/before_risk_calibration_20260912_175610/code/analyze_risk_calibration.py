...
This is a diagnostic ablation, not a replacement for the full MILP or result2.xlsx.
...
def main():
    ...
    output = {"scope": "Fixed battery schedule; causal day-ahead purchase-buffer ablation; not a reoptimized MILP or official result workbook",
