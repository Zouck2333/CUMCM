...
|---|---:|---:|
| 滚动方案 | 14,766,382.86 | — |
| 匹配完美信息 MILP | 12,244,312.30 | Gap_info = 20.5979% |
| 完美信息 LP 下界 | 12,226,042.07 | Gap_LP = 20.7781% |
...
- 匹配 MILP：status=0，MIP gap=1.5212329634243963e-16，耗时 295.368 秒。
- LP 下界：status=0，迭代次数=116645，耗时 4.391 秒。
- 匹配 MILP 物理核验：通过。
- LP 下界物理核验：通过。
