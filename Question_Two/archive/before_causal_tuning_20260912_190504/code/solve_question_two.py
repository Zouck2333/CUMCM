...
def run_model(
    ...
    *,
    ...
    for day_index in range(limit):
        ...
        if day_index == 0:
            ...
            predicted_load = calendar_load_forecast(
                actual_load, dates, day_index, window=load_window_days, degree=load_trend_degree,
            )
            predicted_pv = recent_pv_forecast(actual_pv, day_index, window=pv_window_days)
        else:
    ...
    diagnostics = {
        ...
        "parameter_selection_scope": "retrospective 2025 development; each daily prediction uses only earlier days",
